...
#Cargar Data PIP
dato <- read_excel("C:/Users/sanan/Downloads/PIB.xlsx")
str(dato)
...
plot(datos.ts)
plot(datos.ts, main="Serie de Tiempo", ylab = "PIB", xlab = "Tiempo")
...
plot(datoslog)
plot(datoslog, main="Serie de Tiempo", ylab = "PIB", xlab = "Tiempo")
